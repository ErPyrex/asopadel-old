...
app_name = (
    "users"  # ¡Crucial para que LOGIN_URL = 'users:login' funcione en settings.py!
)
...
urlpatterns = [
    ...
    path(
        "admin-management/", admin_management.admin_management, name="admin_management"
    ),
    path(
        "admin-management/promote/<int:user_id>/",
        admin_management.promote_to_admin,
        name="promote_to_admin",
    ),
    path(
        "admin-management/demote/<int:user_id>/",
